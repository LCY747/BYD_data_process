...
# =============================================================================
file_path = r"E:\Documents\BYD电池测试\数据文件1\20260624_250_300cycle"   # 文件路径
# 获取当前文件路径下所有的txt文件
...
# 拟提取的片段数据
start= "2026-06-24 15:48:38"
end= "2026-06-26 19:32:47"
startTime = int(start.translate(str.maketrans('', '', '-: ')))
endTime = int(end.translate(str.maketrans('', '', '-: ')))
...
#---------------------------------解析参数初始化-------------------------------#
# 温度和应变测量传感器的初始波长
WL0_temper_broadside = np.array([1529.8864	,1531.9153	,1533.8837	,1535.7939	,
                                 1537.7736	,1539.6997	,1541.75	,1543.7053	,1545.6136])          # 侧面温度测量的初始波长
WL0_strain_broadside = np.array([1530.0303	,1531.9158	,1534.0702	,1535.9789	,
                                 1537.9342	,1539.9264	,1541.8964	,1543.828	,1545.8103])          # 侧面应变测量的初始波长

WL0_temper_middle = np.array([1529.8522,1531.8851	,1533.8021	,1535.7743	,1537.7034	,
                            1539.7103	,1541.6857	,1543.6346	,1545.6097])                     # 大面中温度测量的初始波长
WL0_strain_middle = np.array([1530.0134	,1531.8618	,1533.808	,1535.8416	,
                            1537.8505	,1539.8228	,1541.7343	,1543.6699	,1545.7218])          # 大面中应变测量的初始波长

WL0_temper_top = np.array([1529.8484, 1531.8276, 1533.7847, 1535.7687 , 1537.7682, 
                             1539.6661, 1541.6595, 1543.6062, 1545.6398 ])          # 大面上温度测量的初始波长
WL0_strain_top = np.array([1530.0114,1531.9177	,1533.8529	,1535.8484	,1537.8396	,
                             1539.7825	,1541.646	,1543.694	,1545.5775]) # 大面上应变测量的初始波长
